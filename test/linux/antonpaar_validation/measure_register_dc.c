...
void MeasureBufferRegisterDc(uint16 slave)
{
   ...
   static int64 registersSync[2];    //before 10
   ...
   case 0: //Wait 5000 cycles in OP before measure
      ...
      break;
   case 1:
      ec_FPRD(0x1000 + slave, REG_NEXT_SYNC0_ADDR, 16, registersSync, EC_TIMEOUTRET3);  //read NextSync0 (0x990) and NextSync1 (0x998)
