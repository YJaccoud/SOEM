...
#define HALF_RANGE_INPUT     (32768)
#define INPUT_ANALOG         ( (uint16)( (int32)HALF_RANGE_INPUT + ((int32)*((int16*)((int8*)pInput + INPUT_ANALOG_OFFSET))) ) )
...
void MeasureInputValueAndWriteFile(void* pInput)
{
