...
#define INPUT_ANALOG_OFFSET 2       //2: EK1100 + EL3104 only
...
//for measure and write single buffer (MeasureInputValueAndWriteFile(...))
#define SAMPLE_NUMBER                  1400000  // 1'400'000

//for measure and write double buffer (MeasureInputValueDoubleBuffer(...) & WriteInputValueDoubleBuffer())
...
void MeasureInputValueDoubleBuffer(void* pInput);
void WriteInputValueDoubleBuffer();

void MeasureInputValueAndWriteFile(void* pInput);   //only for short measure
